#!/usr/bin/env python3
"""
Debug script untuk test plate detection tanpa YOLO
"""
import time
import logging
...
def test_no_yolo_detection():
    """Test plate detection tanpa YOLO"""
    logger.info("🧪 Testing plate detection without YOLO...")

    # Initialize stream manager dengan YOLO DISABLED
    manager = HeadlessStreamManager(
        source=CCTVConfig.DEFAULT_RTSP_URL,
        enable_yolo=False,  # NO YOLO
